...
```bash  
python -u main.py -tt syn -tm I2I -f Feedback -did 1 -ab 1 -T 3 -eps 5 -rvpl 10 -vpl 100 -sgen StableDiffusion -cret 1 -cue ResNet18 -cmodel ResNet18 -cmp 1 -cef 1 -cdata COVIDx -r PE
```  